...
async fn main() {
    ...
    let http_client = match aster_spot_client
    ...
    match aster_spot_client
        .send_http_request(
            &http_client,
            Request::PlaceOrder(PlaceOrderRequest {
                symbol: symbol.clone(),
                client_order_id: aster_spot_client.generate_next_client_order_id(),
    ...
    let order_ids: Vec<String> = match aster_spot_client
        .send_http_request(
            &http_client,
