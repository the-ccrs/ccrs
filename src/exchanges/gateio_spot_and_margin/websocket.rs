    ...
    for crate::exchanges::gateio_spot_and_margin::common::GateioSpotAndMarginClient
{
    fn websocket_api_url(&self, endpoint: crate::types::WebSocketEndpoint) -> String {
        match endpoint {
            crate::types::WebSocketEndpoint::GateioSpotAndMargin(gateio_endpoint) => {
                match gateio_endpoint {
                    crate::types::GateioSpotAndMarginWebSocketEndpoint::MarketData => {
                        self.websocket_market_data_api_url.to_string()
                    }
                    crate::types::GateioSpotAndMarginWebSocketEndpoint::AccountData => {
                        self.websocket_account_data_api_url.to_string()
                    }
                    crate::types::GateioSpotAndMarginWebSocketEndpoint::Unknown => {
                        panic!("GateioSpotAndMargin endpoint is Unknown")
                    }
                }
            }
            _ => {
    ...
    fn create_subscribe_top_of_book_websocket_request(
        ...
        msg.insert(
            "channel".to_string(),
            serde_json::Value::String("spot.book_ticker".to_string()),
        );
        msg.insert(
            "event".to_string(),
    ...
    fn create_subscribe_trade_websocket_request(
        ...
        msg.insert(
            "channel".to_string(),
            serde_json::Value::String("spot.trades".to_string()),
        );
        msg.insert(
            "event".to_string(),
            serde_json::Value::String("subscribe".to_string()),
    ...
    fn populate_websocket_text_payload_summary(
        ...
        if let Some(json_payload) = &websocket_text.json_payload {
            ...
            if let Some(result) = json_payload.get("result") {
                ...
                websocket_text
                    .payload_summary
                    .insert("result_null".to_string(), result.is_null().to_string());
            }

            if let Some(header) = json_payload.get("header") {
                let channel_is_login =
                    header.get("channel").and_then(|v| v.as_str()) == Some("spot.login");
    ...
    fn is_websocket_text_top_of_book_subscription_data(
        ...
        websocket_text.payload_summary.get("channel") == Some(&"spot.book_ticker".to_string())
    }
    ...
    fn is_websocket_text_trade_subscription_data(
        ...
        websocket_text.payload_summary.get("channel") == Some(&"spot.trades".to_string())
    }
    ...
    fn is_websocket_text_order_subscription_data(
        ...
        websocket_text.payload_summary.get("channel") == Some(&"spot.orders".to_string())
    }
            ...
            crate::exchange_client::common::TopOfBookSubscriptionData {
                data: vec![crate::types::TopOfBook {
                    exchange_instrument_type:
                        crate::types::ExchangeInstrumentType::GateioSpotAndMargin(
    ...
    fn create_subscribe_trade_websocket_subscription_data(
        ...
        let side = match result.get("side").and_then(|v| v.as_str()) {
        ...
        let fills: Vec<crate::types::Fill> = data_array
            ...
            .map(|data| {
                let exchange_instrument_type =
                    crate::types::ExchangeInstrumentType::GateioSpotAndMargin(self.instrument_type);
    ...
    fn is_websocket_text_success_response(
        ...
        payload_summary.get("result.status") == Some(&"success".to_string())
            || payload_summary.get("channel") == Some(&"spot.pong".to_string())
